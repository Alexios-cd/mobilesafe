...
/**
 * Android系统工具类，得到一些系统的信息<br>
 * 主要功能：<br>
 * 1.获取android系统版本号getOSVersion<br>
 * 2.获得android系统sdk版本号getOSVersionSDK或者 getOSVersionSDKINT<br>
 * 3.获取手机型号getDeviceModel<br>
 * 4.获取设备的IMEI，getIMEI<br>
 * 5.检测手机是否已插入SIM卡isCheckSimCardAvailable<br>
 * 6.sim卡是否可读isCanUseSim<br>
 * 7.取得当前sim手机卡的imsi，getIMSI<br>
 * 8.返回本地手机号码，这个号码不一定能获取到getNativePhoneNumber<br>
 * 9.返回手机服务商名字getProvidersName<br>
 * 10.获取当前设备的SNgetSimSN<br>
 * 11.获取当前设备的MAC地址getMacAddress<br>
 * 12.获得设备ip地址getLocalAddress<br>
 * 13.获取屏幕的分辨率getResolution<br>
 * 14.获得设备的横向dpi，getWidthDpi<br>
 * 15.获得设备的纵向dpi，getHeightDpi<br>
 * 16.显示软键盘showSoft<br>
 * 17.隐藏软键盘hideSoft<br>
 * @author 傅文江
 * @2015-1-7 上午11:12:24
...
public class SystemUtils {
	...
	/**
	 * 获取屏幕需要的屏幕最短边(仅当Android 3.2以上可以使用)
	 * @return
	 */
	@SuppressLint("NewApi") 
	public static int getScreenFitShortestParameter() {
		Configuration config = UIUtils.getContext().getResources()
				.getConfiguration();
